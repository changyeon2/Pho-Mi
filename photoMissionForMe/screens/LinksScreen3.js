      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.getStartedContainer}>
            {image ? null : (
              <Text style={styles.getStartedText}>Dog Mission</Text>
            )}
          </View>
    ...
    return (
      ...
      >
        ...
        <View style={styles.helpContainer}>
            ...
            renderItem={({ item }) => <Text style={styles.resultFont}>{item.description == "Dog" ? updateUserSuccess(this.state.user) : ""}Result : {item.description == "Dog" ? "Success" : "Fail"}</Text>
          }
              />
            )}
        </View>
