      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.getStartedContainer}>
            {image ? null : (
              <Text style={styles.getStartedText}>Flower Mission</Text>
            )}
          </View>
    ...
    return (
      ...
      >
        ...
        <View style={styles.helpContainer}>
            ...
            renderItem={({ item }) => <Text style={styles.resultFont}>{item.description == "Flower" ? updateUserSuccess(this.state.user) : ""}Result : {item.description == "Flower" ? "Success" : "Fail"}</Text>
          }
              />
            )}
        </View>
