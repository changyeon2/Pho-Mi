      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.getStartedContainer}>
            {image ? null : (
              <Text style={styles.getStartedText}>Leaf Mission</Text>
            )}
          </View>
    ...
    return (
      ...
      >
        ...
        <View style={styles.helpContainer}>
            ...
            renderItem={({ item }) => <Text style={styles.resultFont}>{item.description == "Leaf" ? updateUserSuccess(this.state.user) : ""}Result : {item.description == "Leaf" ? "Success" : "Fail"}</Text>
          }
              />
            )}
        </View>
