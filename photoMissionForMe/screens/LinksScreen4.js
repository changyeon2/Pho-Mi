      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.getStartedContainer}>
            {image ? null : (
              <Text style={styles.getStartedText}>Pizza Mission</Text>
            )}
          </View>
    ...
    return (
      ...
      >
        ...
        <View style={styles.helpContainer}>
            ...
            renderItem={({ item }) => <Text style={styles.resultFont}>{item.description == "Pizza" ? updateUserSuccess(this.state.user) : ""}Result : {item.description == "Pizza" ? "Success" : "Fail"}</Text>
          }
              />
            )}
        </View>
