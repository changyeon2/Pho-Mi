      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.getStartedContainer}>
            {image ? null : (
              <Text style={styles.getStartedText}>Cat Mission</Text>
            )}
          </View>
    ...
    return (
      ...
      >
        ...
        <View style={styles.helpContainer}>
            ...
            renderItem={({ item }) => <Text style={styles.resultFont}>{item.description == "Cat" ? updateUserSuccess(this.state.user) : ""}Result : {item.description == "Cat" ? "Success" : "Fail"}</Text>
          }
              />
            )}
        </View>
